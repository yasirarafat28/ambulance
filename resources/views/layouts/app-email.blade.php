        ...
        <td>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0"
                ...
                <tr style="vertical-align: bottom;">
                    <td>
                        <a href="">
                            <a href=""><h1 class="text-white">{{$setting->app_name}}</h1>
                        </a>
                    </td>
                ...
                <tr style="text-align: center">
                    <td>
                        <div style="padding-bottom: 20px;">
                            ...
                            <a style="color: #fff;text-decoration: none;margin:10px 5px 0 5px;display: inline-block;" href="{{url('contact')}}">Contact us</a>
                        </div>
                    </td>
                </tr>
                <tr style="text-align: center">
                    ...
                    <td>
                        ...
                        <div style="margin-top: 30px;">
                                <span style="color: #fff;">&copy; {{date('Y')}} <a
                                        ...
                                        href="{{url('/')}}">{{$setting->app_name}}</a>. All Rights Reserved</span>
                        </div>
                    </td>
